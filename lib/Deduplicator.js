...
var options;
function DedupePlugin(opts) { options = opts || {}; };
  ...
  compiler.plugin("compilation", function(compilation) {
    ...
    compilation.mainTemplate.plugin("modules", function(orginalSource, chunk) {
      ...
      source.add(this.indent([
        ...
        "function createProxy(i){return function(module, exports, __webpack_require__){module.exports = __webpack_require__(i);};}",
        ...
        this.indent([
          ...
          this.indent([
            ...
            this.indent([
              "// Module is a copy of another module",
              "modules[i] = "+(options.clone === false ? "createProxy(modules[i]);": "modules[modules[i]];"),
              "break;"
            ]),
            "}"
          ]),
